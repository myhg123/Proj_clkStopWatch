...
HD_PWD='D:/ish/verilog/vivadoWS/Proj_clkStopWatch/Prj_clkStopWatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prjClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prjClock.tcl
