...
HD_PWD='D:/ish/verilog/vivadoWS/Proj_clkStopWatch/Prj_clkStopWatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prjClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prjClock.tcl -notrace
